...
//função que verifica se colidiu com obstáculos, se sim, perde-se a vida
...
//função que verifica se colidiu com o outro carro
  ...
  perderVida(){
    ...
    //código que verifica se o player está apertando para esquerda
    if(this.esquerda){
      //se sim move para direita
      player.positionX +=100;
    }
    //senão, move para esquerda
    else{
      player.positionX -=100;
